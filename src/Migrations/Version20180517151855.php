 ...
 */
class Version20180517151855 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_category (category_id INT NOT NULL, user_id INT NOT NULL, note INT DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, inserted_at DATETIME DEFAULT NULL, INDEX IDX_E6C1FDC1A76ED395 (user_id), PRIMARY KEY(category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
